        ...
        <div className={cn('grid grid-cols-2 gap-3 relative', unpinnedSectionClassName)}>
          {unpinned.map((item) => (
            <motion.div
              ...
              className="border-2 hover:border-4 border-solid border-gray-300 dark:border-white/30 hover:border-double flex items-center justify-between gap-5 rounded-xl bg-theme p-1 md:p-2 group cursor-pointer hover-list-item">

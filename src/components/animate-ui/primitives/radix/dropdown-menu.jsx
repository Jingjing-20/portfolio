...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      disabled={disabled}
      textValue={textValue}
      render={<motion.div data-slot="dropdown-menu-sub-trigger" data-disabled={disabled} {...props} />}></DropdownMenuPrimitive.SubTrigger>
  );
}
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      onSelect={onSelect}
      textValue={textValue}
      render={<motion.div data-slot="dropdown-menu-item" data-disabled={disabled} {...props} />}></DropdownMenuPrimitive.Item>
  );
}
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      render={<motion.div
        ...
        {...props} />}></DropdownMenuPrimitive.CheckboxItem>
  );
}
...
function DropdownMenuRadioItem({
  ...
  return (
    <DropdownMenuPrimitive.RadioItem
      ...
      onSelect={onSelect}
      textValue={textValue}
      render={<motion.div data-slot="dropdown-menu-radio-item" data-disabled={disabled} {...props} />}></DropdownMenuPrimitive.RadioItem>
  );
}
...
function DropdownMenuItemIndicator(props) {
  return (
    <DropdownMenuPrimitive.ItemIndicator
      ...
      render={<motion.div {...props} />}></DropdownMenuPrimitive.ItemIndicator>
  );
}

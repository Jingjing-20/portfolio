                        ...
                        <div className="flex gap-4 items-start">
                          ...
                          {project.coverImage && (
                            <div className="flex-shrink-0 w-30 md:w-35 relative group">
                              <div
                                className="relative p-1 md:p-1.5 rounded-lg shadow-xl bg-textured border-2 hover:border-4 border-solid border-gray-300 dark:border-white/20 hover:border-double cursor-pointer hover-card"

...
function ArrowIcon({ className = '', size = '1em' }) {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M8.293 2.293a1 1 0 0 1 1.414 0l4.5 4.5a1 1 0 0 1 0 1.414l-4.5 4.5a1 1 0 0 1-1.414-1.414L11 8.5H1.5a1 1 0 0 1 0-2H11L8.293 3.707a1 1 0 0 1-1.414-1.414"
      />
    </svg>
  );
}
...
const NAV_ITEMS = [
  {
    value: 'home',
    label: 'Home',
    icon: <HomeIcon size={14} className="shrink-0" />,
  },
  {
    value: 'about',
    label: 'About',
      ...
      {THEME_OPTIONS.map(({ value, label, icon: Icon }) => {
        ...
        return (
          <button
            ...
            style={
              isActive
                ? { viewTransitionName: `theme - toggle - ${value} ` }
                : undefined
            }
            className={cn(
              buttonSize,
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isMobile
                ? 'gap-2.5 py-2.5 px-3 rounded-md text-xs font-medium'
                : 'gap-2 px-1 py-1.5 text-xs font-medium'
            )}
          >
            {isActive && (
              <ArrowIcon

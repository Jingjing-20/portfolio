export const TECH_STACK = [
  {
    ...
    tools: ['HTML', 'CSS', 'JavaScript', 'TypeScript', 'Tailwind CSS', 'Bootstrap', 'React', 'Vite', 'PHP', 'Laravel', 'Python', 'Django', 'Node.js', 'REST APIs'],
  },
  {
    category: 'Databases & Backend Services',
    description: 'Relational databases and cloud-hosted data storage.',
  ...
  },
  {
    ...
    description: 'Version control, automation pipelines, and modern AI development workflows.',
    tools: ['Git', 'GitHub', 'GitHub Actions', 'Antigravity', 'Claude', 'Codex'],
  },
];